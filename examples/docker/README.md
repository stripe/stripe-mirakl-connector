...
Based on [TrafeX/docker-php-nginx](https://github.com/TrafeX/docker-php-nginx), this sample project shows how to build and start the [Stripe Mirakl Connector](../../) application on PHP-FPM 7.3, Nginx 1.16 and PostgreSQL 11.5 using Docker.
