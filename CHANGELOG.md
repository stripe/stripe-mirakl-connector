...
- Consequently, endpoint `/api/onboarding` has been removed, the `AccountOnboarding` entity deleted, and the `STRIPE_CLIENT_ID` environment variable is no longer needed
